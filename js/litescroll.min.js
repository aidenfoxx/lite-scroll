...
f<g?f:g);this.content.style.transitionDuration=c+"ms";this.content.style.transitionTimingFunction=d;this.content.style.transform="translate("+this.x+"px, "+this.y+"px)"+(this.gpuAcceleration?" translateZ(0px)":"");clearTimeout(this.scrollCallback);e&&(this.scrollCallback=setTimeout(e.bind(this),c))};
