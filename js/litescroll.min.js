...
b[c];this.resizeCallback();this.bindEvents()}LiteScroll.prototype.scrollStart=function(a){};LiteScroll.prototype.scroll=function(a){};LiteScroll.prototype.scrollEnd=function(a){};LiteScroll.prototype.calcRelativePos=function(a,b){return{x:a-this.containerRect.left,y:b-this.containerRect.top}};LiteScroll.prototype.calcTouchCoords=function(a){return this.calcRelativePos(a.changedTouches?a.changedTouches[0].pageX:a.pageX,a.changedTouches?a.changedTouches[0].pageY:a.pageY)};
LiteScroll.prototype.clacPointDistance=function(a,b){var c=b.x-a.x,d=b.y-a.y;return Math.sqrt(c*c+d*d)};LiteScroll.prototype.calcNearestChild=function(){for(var a=null,b=0,c=0,d=this.childRect.length;c<d;c++){var e=this.calcRelativePos(this.childRect[c].left,this.childRect[c].top);e.x=-e.x;e.y=-e.y;e=this.clacPointDistance(this,e);if(!c||e<a)a=e,b=c}return b};
